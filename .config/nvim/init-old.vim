...
call plug#begin()
  ...
  " this needs to go *after* the git plug
  ...
  " Woah SQL templates in my JavaScript!
  Plug 'exu/pgsql.vim'
...
call plug#end()
  ...
  " for vim-javascript-sql to use postgres
...
autocmd FileType vimwiki setlocal noexpandtab tabstop=2 shiftwidth=2 listchars=tab:\ \ 
...
" Boo TypeScript highlighting
au BufRead,BufNewFile *.ts set filetype=javascript


" Vim tend to a have issues with flagging braces as errors, see for example https://github.com/vim-jp/vim-cpp/issues/16
" this is a workaround
let c_no_curly_error=1



" So OmniSharp doesn't use Mono
...
" " NOTE: you may want to enable no select by `"suggest.noselect": true`
...
" Make sure tabs are always 2 spaces for HTML
